...
def test_get_account(client, mock_db):
    ...
    response = client.get('/get_account?account_id=1')
...
def test_get_account_not_found(client, mock_db):
    ...
    response = client.get('/get_account?account_id=999')
...
def test_delete_account(client, mock_db):
    ...
    response = client.delete('/delete_account?account_id=1')
...
def test_delete_account_invalid_id(client):
    response = client.delete('/delete_account?account_id=invalid')

    assert response.status_code == 400
    assert b"account_id must be an integer" in response.data